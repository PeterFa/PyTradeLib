...
class Position(object):
    ...
    :type strategy: :class:`pytradelab.strategy.Strategy`.
    :param entry_order: The order used to enter the position.
    :type entry_order: :class:`pytradelab.broker.Order`
    ...
    def get_entry_order(self):
        """ Returns the :class:`pytradelab.broker.Order` used to enter the
        position."""
    ...
    def get_exit_order(self):
        """Returns the :class:`pytradelab.broker.Order` used to exit the
...
class Strategy(object):
    ...
    :type cash: int/float.
    :param broker_: Broker to use. If not specified the default backtesting broker (:class:`pytradelab.broker.backtesting.Broker`)
                    will be used.
    :type broker_: :class:`pytradelab.broker.Broker`.
    ...
    def attach_analyzer(self, strategy_analyzer):
        """Adds a :class:`pytradelab.stratanalyzer.StrategyAnalyzer`."""
    ...
    def get_feed(self):
        """Returns the :class:`pytradelab.barfeed.BarFeed` that this strategy is using."""
        return self.__feed

    def get_current_date_time(self):
        """Returns the :class:`datetime.datetime` for the current :class:`pytradelab.bar.Bar`."""
        ret = None
    ...
    def get_broker(self):
        """Returns the :class:`pytradelab.broker.Broker` used to handle order executions."""
        return self.__broker

    def enter_long(self, symbol, quantity, good_until_canceled=False):
        """Generates a buy :class:`pytradelab.broker.MarketOrder` to enter a long position.
    ...
    def enter_short(self, symbol, quantity, good_until_canceled=False):
        """Generates a sell short :class:`pytradelab.broker.MarketOrder` to enter a short position.
    ...
    def enter_long_limit(self, symbol, limit_price, quantity, good_until_canceled=False):
        """Generates a buy :class:`pytradelab.broker.LimitOrder` to enter a long position.
    ...
    def enter_short_position(self, symbol, limit_price, quantity, good_until_canceled=False):
        """Generates a sell short :class:`pytradelab.broker.LimitOrder` to enter a short position.
    ...
    def enter_long_stop(self, symbol, stop_price, quantity, good_until_canceled=False):
        """Generates a buy :class:`pytradelab.broker.StopOrder` to enter a long position.
    ...
    def enter_short_stop(self, symbol, stop_price, quantity, good_until_canceled=False):
        """Generates a sell short :class:`pytradelab.broker.StopOrder` to enter a short position.
    ...
    def enter_long_stop_limit(self, symbol, limit_price, stop_price, quantity, good_until_canceled=False):
        """Generates a buy :class:`pytradelab.broker.StopLimitOrder` order to enter a long position.
    ...
    def enter_short_stop_limit(self, symbol, limit_price, stop_price, quantity, good_until_canceled=False):
        """Generates a sell short :class:`pytradelab.broker.StopLimitOrder` order to enter a short position.
    ...
    def exit_position(self, position, limit_price=None, stop_price=None, good_until_canceled=None):
        ...
        .. note::
            ...
            * If limit_price is not set and stop_price is not set, then a :class:`pytradelab.broker.MarketOrder` is used to exit the position.
            * If limit_price is set and stop_price is not set, then a :class:`pytradelab.broker.LimitOrder` is used to exit the position.
            * If limit_price is not set and stop_price is set, then a :class:`pytradelab.broker.StopOrder` is used to exit the position.
            * If limit_price is set and stop_price is set, then a :class:`pytradelab.broker.StopLimitOrder` is used to exit the position.
        """
    ...
    def on_finish(self, bars):
        ...
        :type bars: :class:`pytradelab.bar.Bars`.
        """
        pass
    ...
    def on_order_updated(self, order):
        ...
        :type order: :class:`pytradelab.broker.Order`.
        """
        pass
