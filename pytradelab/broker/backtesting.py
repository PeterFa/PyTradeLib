...
class FillStrategy(object):
    ...
    def fill_market_order(self, order, broker_, bar):
        ...
        :type order: :class:`pytradelab.broker.MarketOrder`.
        :param broker_: The broker.
        :type broker_: :class:`Broker`.
        :param bar: The current bar.
        :type bar: :class:`pytradelab.bar.Bar`.
    ...
    def fill_limit_order(self, order, broker_, bar):
        ...
        :param order: The order.
        :type order: :class:`pytradelab.broker.LimitOrder`.
        :param broker_: The broker.
        :type broker_: :class:`Broker`.
        :param bar: The current bar.
        :type bar: :class:`pytradelab.bar.Bar`.
    ...
    def fill_stop_order(self, order, broker_, bar):
        ...
        :param order: The order.
        :type order: :class:`pytradelab.broker.StopOrder`.
        :param broker_: The broker.
        :type broker_: :class:`Broker`.
        :param bar: The current bar.
        :type bar: :class:`pytradelab.bar.Bar`.
    ...
    def fill_stop_limit_order(self, order, broker_, bar, just_hit_stop_price):
        ...
        :param order: The order.
        :type order: :class:`pytradelab.broker.StopLimitOrder`.
        :param broker_: The broker.
        :type broker_: :class:`Broker`.
        :param bar: The current bar.
        :type bar: :class:`pytradelab.bar.Bar`.
...
class DefaultStrategy(FillStrategy):
    ...
    * A :class:`pytradelab.broker.MarketOrder` is always filled using the open/close price.
    * A :class:`pytradelab.broker.LimitOrder` will be filled like this:
    ...
    * A :class:`pytradelab.broker.StopOrder` will be filled like this:
    ...
    * A :class:`pytradelab.broker.StopLimitOrder` will be filled like this:
