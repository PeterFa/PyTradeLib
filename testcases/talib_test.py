...
class TestCase(unittest.TestCase):
    ...
    def __loadMedPriceDS(self):
        ...
        for i in xrange(len(OPEN_VALUES)):
            ret.append_value(LOW_VALUES[i] + (HIGH_VALUES[i] - LOW_VALUES[i]) / 2.0)
        return ret
    ...
    def __loadBarDS(self):
        ...
        for i in xrange(len(OPEN_VALUES)):
            ...
            ret.append_value(bar.Bar(date_time, OPEN_VALUES[i], HIGH_VALUES[i], LOW_VALUES[i], CLOSE_VALUES[i], VOLUME_VALUES[i], CLOSE_VALUES[i]))
            seconds += 1
        return ret
    ...
    def __loadSarTestBarDs(self):
        ...
        for i in xrange(len(SAR_HIGH)):
            date_time = datetime.datetime.now() + datetime.timedelta(seconds=seconds)
            ret.append_value(bar.Bar(date_time, SAR_LOW[i], SAR_HIGH[i], SAR_LOW[i], SAR_HIGH[i], 0, SAR_LOW[i]))
            seconds += 1
        return ret
    ...
    def testAPO(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.APO(barDs.get_close_data_series(), 252, 26, 12, talib.MA_Type.SMA)[25], -3.3124))
        self.assertTrue(compare(indicator.APO(barDs.get_close_data_series(), 252, 12, 26, talib.MA_Type.SMA)[25], -3.3124))
        self.assertTrue(compare(indicator.APO(barDs.get_close_data_series(), 252, 12, 26, talib.MA_Type.SMA)[26], -3.5876))
        self.assertTrue(compare(indicator.APO(barDs.get_close_data_series(), 252, 12, 26, talib.MA_Type.SMA)[-1], -0.1667))
    ...
    def testBBANDS(self):
        barDs = self.__loadBarDS()
        # EMA
        self.assertTrue(compare(indicator.BBANDS(barDs.get_close_data_series(), 252, 20, 2.0, 2.0, talib.MA_Type.EMA)[0][19+13], 93.674))
        self.assertTrue(compare(indicator.BBANDS(barDs.get_close_data_series(), 252, 20, 2.0, 2.0, talib.MA_Type.EMA)[1][19+13], 87.679))
        self.assertTrue(compare(indicator.BBANDS(barDs.get_close_data_series(), 252, 20, 2.0, 2.0, talib.MA_Type.EMA)[2][19+13], 81.685))
        # SMA
        self.assertTrue(compare(indicator.BBANDS(barDs.get_close_data_series(), 252, 20, 2.0, 2.0, talib.MA_Type.SMA)[0][19], 98.0734))
        self.assertTrue(compare(indicator.BBANDS(barDs.get_close_data_series(), 252, 20, 2.0, 2.0, talib.MA_Type.SMA)[1][19], 92.8910))
        self.assertTrue(compare(indicator.BBANDS(barDs.get_close_data_series(), 252, 20, 2.0, 2.0, talib.MA_Type.SMA)[2][19], 87.7086))

    def testBETA(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.BETA(barDs.get_high_data_series(), barDs.get_low_data_series(), 252, 5)[5], 0.62907))
        self.assertTrue(compare(indicator.BETA(barDs.get_high_data_series(), barDs.get_low_data_series(), 252, 5)[6], 0.83604))
    ...
    def testCMO(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.CMO(barDs.get_close_data_series(), 252, 14)[14], -1.70, 1))

    def testCORREL(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.CORREL(barDs.get_high_data_series(), barDs.get_low_data_series(), 252, 20)[19], 0.9401569))
        self.assertTrue(compare(indicator.CORREL(barDs.get_high_data_series(), barDs.get_low_data_series(), 252, 20)[20], 0.9471812))
        self.assertTrue(compare(indicator.CORREL(barDs.get_high_data_series(), barDs.get_low_data_series(), 252, 20)[-1], 0.8866901))
    ...
    def testEMA(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.EMA(barDs.get_close_data_series(), 252, 2)[1], 93.16)) # Original value 93.15
        self.assertTrue(compare(indicator.EMA(barDs.get_close_data_series(), 252, 2)[2], 93.97)) # Original value 93.96
        self.assertTrue(compare(indicator.EMA(barDs.get_close_data_series(), 252, 2)[-1], 108.22)) # Original value 108.21
        self.assertTrue(compare(indicator.EMA(barDs.get_close_data_series(), 252, 10)[9], 93.23)) # Original value 93.22
    ...
    def testKAMA(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.KAMA(barDs.get_close_data_series(), 252, 10)[10], 92.6575))
        self.assertTrue(compare(indicator.KAMA(barDs.get_close_data_series(), 252, 10)[11], 92.7783))
        self.assertTrue(compare(indicator.KAMA(barDs.get_close_data_series(), 252, 10)[-1], 109.294))

    def testMA(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.MA(barDs.get_close_data_series(), 252, 2, talib.MA_Type.SMA)[1], 93.16)) # Original value 93.15
        self.assertTrue(compare(indicator.MA(barDs.get_close_data_series(), 252, 2, talib.MA_Type.SMA)[2], 94.59))
        self.assertTrue(compare(indicator.MA(barDs.get_close_data_series(), 252, 2, talib.MA_Type.SMA)[3], 94.73))
        self.assertTrue(compare(indicator.MA(barDs.get_close_data_series(), 252, 2, talib.MA_Type.SMA)[-1], 108.31))

    def testMACD(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.MACD(barDs.get_close_data_series(), 252, 12, 26, 9)[0][33], -1.9738))
        self.assertTrue(compare(indicator.MACD(barDs.get_close_data_series(), 252, 12, 26, 9)[1][33], -2.7071))
        self.assertTrue(compare(indicator.MACD(barDs.get_close_data_series(), 252, 12, 26, 9)[2][33], (-1.9738)-(-2.7071)))
        self.assertTrue(compare(indicator.MACD(barDs.get_close_data_series(), 252, 26, 12, 9)[0][33], -1.9738))
        self.assertTrue(compare(indicator.MACD(barDs.get_close_data_series(), 252, 26, 12, 9)[1][33], -2.7071))
        self.assertTrue(compare(indicator.MACD(barDs.get_close_data_series(), 252, 26, 12, 9)[2][33], (-1.9738)-(-2.7071)))

    def testMACDEXT(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.MACDEXT(barDs.get_close_data_series(), 252, 12, talib.MA_Type.EMA , 26, talib.MA_Type.EMA, 9, talib.MA_Type.EMA)[0][33], -1.9738))
        self.assertTrue(compare(indicator.MACDEXT(barDs.get_close_data_series(), 252, 12, talib.MA_Type.EMA , 26, talib.MA_Type.EMA, 9, talib.MA_Type.EMA)[1][33], -2.7071))
        self.assertTrue(compare(indicator.MACDEXT(barDs.get_close_data_series(), 252, 12, talib.MA_Type.EMA , 26, talib.MA_Type.EMA, 9, talib.MA_Type.EMA)[2][33], (-1.9738)-(-2.7071)))
    ...
    def testMAX(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.MAX(barDs.get_open_data_series(), 252, 14)[13], 98.815))
        self.assertTrue(compare(indicator.MAX(barDs.get_open_data_series(), 252, 14)[14], 98.815))
        self.assertTrue(compare(indicator.MAX(barDs.get_open_data_series(), 252, 14)[-1], 110.69))
    ...
    def testMIN(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.MIN(barDs.get_open_data_series(), 252, 14)[13], 91.125))
        self.assertTrue(compare(indicator.MIN(barDs.get_open_data_series(), 252, 14)[14], 91.125))
        self.assertTrue(compare(indicator.MIN(barDs.get_open_data_series(), 252, 14)[-1], 107.75))
    ...
    def testMOM(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.MOM(barDs.get_close_data_series(), 252, 14)[14], -0.50))
        self.assertTrue(compare(indicator.MOM(barDs.get_close_data_series(), 252, 14)[15], -2.00))
        self.assertTrue(compare(indicator.MOM(barDs.get_close_data_series(), 252, 14)[16], -5.22))
        self.assertTrue(compare(indicator.MOM(barDs.get_close_data_series(), 252, 14)[-1], -1.13))
    ...
    def testPPO(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.PPO(barDs.get_close_data_series(), 252, 2, 3, talib.MA_Type.SMA)[2], 1.10264))
        self.assertTrue(compare(indicator.PPO(barDs.get_close_data_series(), 252, 2, 3, talib.MA_Type.SMA)[3], -0.02813))
        self.assertTrue(compare(indicator.PPO(barDs.get_close_data_series(), 252, 2, 3, talib.MA_Type.SMA)[-1], -0.21191))

    def testROC(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.ROC(barDs.get_close_data_series(), 252, 14)[14], -0.546))
        self.assertTrue(compare(indicator.ROC(barDs.get_close_data_series(), 252, 14)[15], -2.109))
        self.assertTrue(compare(indicator.ROC(barDs.get_close_data_series(), 252, 14)[16], -5.53))
        self.assertTrue(compare(indicator.ROC(barDs.get_close_data_series(), 252, 14)[-1], -1.0367))

    def testROCR(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.ROCR(barDs.get_close_data_series(), 252, 14)[14], 0.994536, 4))
        self.assertTrue(compare(indicator.ROCR(barDs.get_close_data_series(), 252, 14)[15], 0.978906, 4))
        self.assertTrue(compare(indicator.ROCR(barDs.get_close_data_series(), 252, 14)[16], 0.944689, 4))
        self.assertTrue(compare(indicator.ROCR(barDs.get_close_data_series(), 252, 14)[-1], 0.989633, 4))

    def testROCR100(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.ROCR100(barDs.get_close_data_series(), 252, 14)[14], 99.4536, 4))
        self.assertTrue(compare(indicator.ROCR100(barDs.get_close_data_series(), 252, 14)[15], 97.8906, 4))
        self.assertTrue(compare(indicator.ROCR100(barDs.get_close_data_series(), 252, 14)[16], 94.4689, 4))
        self.assertTrue(compare(indicator.ROCR100(barDs.get_close_data_series(), 252, 14)[-1], 98.9633, 4))

    def testRSI(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.RSI(barDs.get_close_data_series(), 252, 14)[14], 49.15)) # Original value 49.14
        self.assertTrue(compare(indicator.RSI(barDs.get_close_data_series(), 252, 14)[15], 52.33)) # Original value 52.32
        self.assertTrue(compare(indicator.RSI(barDs.get_close_data_series(), 252, 14)[16], 46.07))
        self.assertTrue(compare(indicator.RSI(barDs.get_close_data_series(), 252, 14)[-1], 49.63))
    ...
    def testSMA(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.SMA(barDs.get_close_data_series(), 252, 2)[1], 93.16)) # Original value 93.15
        self.assertTrue(compare(indicator.SMA(barDs.get_close_data_series(), 252, 2)[2], 94.59))
        self.assertTrue(compare(indicator.SMA(barDs.get_close_data_series(), 252, 2)[3], 94.73))
        self.assertTrue(compare(indicator.SMA(barDs.get_close_data_series(), 252, 2)[-1], 108.31))

    def testSTDDEV(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.STDDEV(barDs.get_close_data_series(), 252, 5.0, 1)[4], 1.2856))
        self.assertTrue(compare(indicator.STDDEV(barDs.get_close_data_series(), 252, 5.0, 1)[5], 0.4462))
        self.assertTrue(compare(indicator.STDDEV(barDs.get_close_data_series(), 252, 5.0, 1)[-1], 0.7144))
        self.assertTrue(compare(indicator.STDDEV(barDs.get_close_data_series(), 252, 5.0, 1.5)[4], 1.9285))
        self.assertTrue(compare(indicator.STDDEV(barDs.get_close_data_series(), 252, 5.0, 1.5)[5], 0.66937))
        self.assertTrue(compare(indicator.STDDEV(barDs.get_close_data_series(), 252, 5.0, 1.5)[-1], 1.075))
    ...
    def testSTOCHRSI(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.STOCHRSI(barDs.get_close_data_series(), 252, 14, 14, 1, talib.MA_Type.SMA)[0][27], 94.156709))
        self.assertTrue(compare(indicator.STOCHRSI(barDs.get_close_data_series(), 252, 14, 14, 1, talib.MA_Type.SMA)[1][27], 94.156709))
        self.assertTrue(compare(indicator.STOCHRSI(barDs.get_close_data_series(), 252, 14, 14, 1, talib.MA_Type.SMA)[0][-1], 0))
        self.assertTrue(compare(indicator.STOCHRSI(barDs.get_close_data_series(), 252, 14, 14, 1, talib.MA_Type.SMA)[1][-1], 0))

        self.assertTrue(compare(indicator.STOCHRSI(barDs.get_close_data_series(), 252, 14, 45, 1, talib.MA_Type.SMA)[0][58], 79.729186))
        self.assertTrue(compare(indicator.STOCHRSI(barDs.get_close_data_series(), 252, 14, 45, 1, talib.MA_Type.SMA)[1][58], 79.729186))
        self.assertTrue(compare(indicator.STOCHRSI(barDs.get_close_data_series(), 252, 14, 45, 1, talib.MA_Type.SMA)[0][-1], 48.1550743))
        self.assertTrue(compare(indicator.STOCHRSI(barDs.get_close_data_series(), 252, 14, 45, 1, talib.MA_Type.SMA)[1][-1], 48.1550743))

    def testT3(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.T3(barDs.get_close_data_series(), 252, 5, 0.7)[24],  85.73))
        self.assertTrue(compare(indicator.T3(barDs.get_close_data_series(), 252, 5, 0.7)[25],  84.37))
        self.assertTrue(compare(indicator.T3(barDs.get_close_data_series(), 252, 5, 0.7)[-2], 109.03))
        self.assertTrue(compare(indicator.T3(barDs.get_close_data_series(), 252, 5, 0.7)[-1], 108.88))
    ...
    def testTRIMA(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.TRIMA(barDs.get_close_data_series(), 252, 10)[9], 93.6043))
        self.assertTrue(compare(indicator.TRIMA(barDs.get_close_data_series(), 252, 10)[10], 93.4252))
        self.assertTrue(compare(indicator.TRIMA(barDs.get_close_data_series(), 252, 10)[-2], 109.1850, 3))
        self.assertTrue(compare(indicator.TRIMA(barDs.get_close_data_series(), 252, 10)[-1], 109.1407))

    def testTRIX(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.TRIX(barDs.get_close_data_series(), 252, 5)[13], 0.2589))
        self.assertTrue(compare(indicator.TRIX(barDs.get_close_data_series(), 252, 5)[14], 0.010495))
        self.assertTrue(compare(indicator.TRIX(barDs.get_close_data_series(), 252, 5)[-2], -0.058))
        self.assertTrue(compare(indicator.TRIX(barDs.get_close_data_series(), 252, 5)[-1], -0.095))
    ...
    def testVAR(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.VAR(barDs.get_close_data_series(), 252, 5.0, 1)[4], 1.2856**2))
        self.assertTrue(compare(indicator.VAR(barDs.get_close_data_series(), 252, 5.0, 1)[5], 0.4462**2))
        self.assertTrue(compare(indicator.VAR(barDs.get_close_data_series(), 252, 5.0, 1)[-1], 0.7144**2))
    ...
    def testWMA(self):
        barDs = self.__loadBarDS()
        self.assertTrue(compare(indicator.WMA(barDs.get_close_data_series(), 252, 2)[1], 93.71))
        self.assertTrue(compare(indicator.WMA(barDs.get_close_data_series(), 252, 2)[2], 94.52))
        self.assertTrue(compare(indicator.WMA(barDs.get_close_data_series(), 252, 2)[3], 94.86)) # Original value 94.85
        self.assertTrue(compare(indicator.WMA(barDs.get_close_data_series(), 252, 2)[-1], 108.16))
