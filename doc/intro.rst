...
PyTradeLib is a Python library that I started with one simple goal in mind: **To make it easy to backtest stock trading strategies**.
...
PyTradeLib was developed with Python 2.7 and depends on:
