...
class Position(object):
    ...
    :type strategy: :class:`pytradelib.strategy.Strategy`.
    :param entry_order: The order used to enter the position.
    :type entry_order: :class:`pytradelib.broker.Order`
    ...
    def get_entry_order(self):
        """ Returns the :class:`pytradelib.broker.Order` used to enter the
        position."""
    ...
    def get_exit_order(self):
        """Returns the :class:`pytradelib.broker.Order` used to exit the
...
class Strategy(object):
    ...
    :type cash: int/float.
    :param broker_: Broker to use. If not specified the default backtesting broker (:class:`pytradelib.broker.backtesting.Broker`)
                    will be used.
    :type broker_: :class:`pytradelib.broker.Broker`.
    ...
    def attach_analyzer(self, strategy_analyzer):
        """Adds a :class:`pytradelib.stratanalyzer.StrategyAnalyzer`."""
    ...
    def get_feed(self):
        """Returns the :class:`pytradelib.barfeed.BarFeed` that this strategy is using."""
        return self.__feed

    def get_current_date_time(self):
        """Returns the :class:`datetime.datetime` for the current :class:`pytradelib.bar.Bar`."""
        ret = None
    ...
    def get_broker(self):
        """Returns the :class:`pytradelib.broker.Broker` used to handle order executions."""
        return self.__broker

    def enter_long(self, symbol, quantity, good_until_canceled=False):
        """Generates a buy :class:`pytradelib.broker.MarketOrder` to enter a long position.
    ...
    def enter_short(self, symbol, quantity, good_until_canceled=False):
        """Generates a sell short :class:`pytradelib.broker.MarketOrder` to enter a short position.
    ...
    def enter_long_limit(self, symbol, limit_price, quantity, good_until_canceled=False):
        """Generates a buy :class:`pytradelib.broker.LimitOrder` to enter a long position.
    ...
    def enter_short_position(self, symbol, limit_price, quantity, good_until_canceled=False):
        """Generates a sell short :class:`pytradelib.broker.LimitOrder` to enter a short position.
    ...
    def enter_long_stop(self, symbol, stop_price, quantity, good_until_canceled=False):
        """Generates a buy :class:`pytradelib.broker.StopOrder` to enter a long position.
    ...
    def enter_short_stop(self, symbol, stop_price, quantity, good_until_canceled=False):
        """Generates a sell short :class:`pytradelib.broker.StopOrder` to enter a short position.
    ...
    def enter_long_stop_limit(self, symbol, limit_price, stop_price, quantity, good_until_canceled=False):
        """Generates a buy :class:`pytradelib.broker.StopLimitOrder` order to enter a long position.
    ...
    def enter_short_stop_limit(self, symbol, limit_price, stop_price, quantity, good_until_canceled=False):
        """Generates a sell short :class:`pytradelib.broker.StopLimitOrder` order to enter a short position.
    ...
    def exit_position(self, position, limit_price=None, stop_price=None, good_until_canceled=None):
        ...
        .. note::
            ...
            * If limit_price is not set and stop_price is not set, then a :class:`pytradelib.broker.MarketOrder` is used to exit the position.
            * If limit_price is set and stop_price is not set, then a :class:`pytradelib.broker.LimitOrder` is used to exit the position.
            * If limit_price is not set and stop_price is set, then a :class:`pytradelib.broker.StopOrder` is used to exit the position.
            * If limit_price is set and stop_price is set, then a :class:`pytradelib.broker.StopLimitOrder` is used to exit the position.
        """
    ...
    def on_finish(self, bars):
        ...
        :type bars: :class:`pytradelib.bar.Bars`.
        """
        pass
    ...
    def on_order_updated(self, order):
        ...
        :type order: :class:`pytradelib.broker.Order`.
        """
        pass
