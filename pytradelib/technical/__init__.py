...
class DataSeriesFilter(TechnicalIndicatorBase):
    """A DataSeriesFilter is a :class:`pytradelib.dataseries.DataSeries` instance that decorates another :class:`pytradelib.dataseries.DataSeries` instance
    to make some calculations with the values from the DataSeries being decorated.

    :param dataSeries: The DataSeries instance being filtered.
    :type dataSeries: :class:`pytradelib.dataseries.DataSeries`.
    ...
    def get_data_series(self):
        """Returns the :class:`pytradelib.dataseries.DataSeries` being filtered."""
