...
class Feed(csvfeed.BarFeed):
    """A :class:`pytradelib.barfeed.csvfeed.BarFeed` that loads bars from CSV files exported from NinjaTrader.

    :param frequency: The frequency of the bars.
    :param timezone: The default timezone to use to localize bars. Check :mod:`pytradelib.marketsession`.
    ...
    def add_bars_from_csv(self, symbol, path, timezone=None):
        ...
        :type path: string.
        :param timezone: The timezone to use to localize bars. Check :mod:`pytradelib.marketsession`.
        :type timezone: A pytz timezone.
        """
