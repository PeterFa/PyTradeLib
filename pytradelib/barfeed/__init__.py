...
from pytradelib.barfeed import helpers
...
# - Event dispatching
# - Building pytradelib.bar.Bars objects for get_bars(bars_ago=0) and get_next_bars()
...
class BarFeed(object):
    ...
    def get_data_series(self, symbol):
        """Returns the :class:`pytradelib.dataseries.BarDataSeries` for the given
        symbol.

        :param symbol: Instrument identifier.
        :type symbol: string.
        :rtype: :class:`pytradelib.dataseries.BarDataSeries`.
        """
    ...
    def __getitem__(self, symbol):
        """Returns the :class:`pytradelib.dataseries.BarDataSeries` for a given
        symbol. If the symbol is not found an exception is raised."""
        return self.__ds[symbol]

    def __contains__(self, symbol):
        """Returns True if a :class:`pytradelib.dataseries.BarDataSeries` for
    ...
    def get_next_bars(self):
        """Returns the next :class:`pytradelib.bar.Bars` in the feed or None if
        there are no bars."""
