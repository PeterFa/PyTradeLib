...
class Returns(stratanalyzer.StrategyAnalyzer):
    ...
    def get_returns(self):
        """Returns a :class:`pytradelib.dataseries.DataSeries` with the returns for each bar."""
        return self.__net_returns

    def get_cumulative_returns(self):
        """Returns a :class:`pytradelib.dataseries.DataSeries` with the cumulative returns for each bar."""
